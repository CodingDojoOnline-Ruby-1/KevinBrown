...
# ================================================================================================================
brandon = (0..255); puts; brandon.each{|num1| puts "New Number: #{num1} Sum: #{y = (0..num1); sum =0; y.each{|num2| sum=sum+num2}; sum}"}
# brandon = (0..255)
# brandon.each{|num1| puts "New Number: #{num1} Sum: #{y = (0..num1); sum =0; y.each{|num2| sum=sum+num2}; sum}"}
...
# for i in 1..carissa.length
#     puts "Item " + (i).to_s + " is " + carissa[i-1].to_s
#     next i
# end #for
...
# ================================================================================================================
charlie = [-3, -5, -7, 0, 5, 13, -6, 4]; puts; puts "The largest Number in the array is " + charlie.max.to_s
# charlie = [-3, -5, -7, 0, 5, 13, -6, 4]
# puts "The largest Number in the array is #{charlie.max}
...
# sum = 0.0
# francisco.each_index{|i| sum += francisco[i]}; puts "The average is #{sum/francisco.count}."
...
# ================================================================================================================
y=[]; puts; for i in 0..256; if i %2 == 1 then y.push(i) end; end; puts "The array 'y' is now: #{y}"
# y=[]
# for i in 0..256
#     if i %2 == 1 then
#         y.push(i)
...
#     i = i - 1
# end #while
# puts "The maximum number in x is #{max}."
# puts "The mininimum number in x is #{min}."
# puts "The average of the numbers in x is #{sum/x.count}."
...
# ================================================================================================================
x = [-1, -3, 2]; puts; puts "x is: #{x}"; i = x.length - 1; while i > -1 do; if x[i] < 0 then x[i] = 'Dojo'; end; i = i - 1; end; puts "x is now: #{x}"
# x = [-1, -3, 2]
# puts
# puts "x is: #{x}"
# i = x.length - 1
